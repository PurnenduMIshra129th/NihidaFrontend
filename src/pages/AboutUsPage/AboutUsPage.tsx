...
import BannerScreen from "../../screens/Background/BannerScreen";
      ...
      <div className="w-full">
        ...
        <div className="px-6 md:px-20 py-12 bg-white text-gray-800">
          <div className="max-w-5xl mx-auto space-y-6">
            ...
            <Heading_2 text="OUR SCOPE & PRESENCE" className="text-custom_orange_1"/>
            <Image imagePath="/orisha.jpg" />
            ...
            <Heading_2 text="NIHIDA STRATEGIC PLAN 2025-30 " className="text-custom_orange_1"/>
