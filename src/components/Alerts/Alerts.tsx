...
function Alerts() {
    ...
    return (
        <>
            <div className={`flex items-center p-4 mb-4 rounded-lg ${styles.bg} ${styles.text} z-50 w-[25rem] fixed top-[4rem] right-[1rem] transition ease-in-out delay-100`} role="alert">
                {/* Icon */}
