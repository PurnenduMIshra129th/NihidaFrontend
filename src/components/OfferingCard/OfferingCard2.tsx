    ...
    return (
        <>
            <div className="flex  flex-col sm:w-1/3">
                ...
                <div className="w-full relative h-[200px] bg-cover bg-center" style={{ backgroundImage: `url(${serviceList[2]?.imagePath || defaultImage})` }}>
                    <div className='absolute -top-[3rem] left-1/2 transform -translate-x-1/2 w-[6rem] h-[6rem] bg-custom_white flex justify-center items-center rounded-full cursor-pointer'>
                        <img src={icon1_1 || defaultImage} className="w-[40%]" alt="no image found"></img>
                    </div>
                </div>
                <div className="bg-custom_yellow w-full p-3 flex flex-col justify-center items-center pb-[3.5rem] break-all">
                ...
                <div className="w-full relative h-[200px] bg-cover bg-center" style={{ backgroundImage: `url(${serviceList[3]?.imagePath || defaultImage})` }}>
                    <div className='absolute -top-[3rem] left-1/2 transform -translate-x-1/2 w-[6rem] h-[6rem] bg-custom_white flex justify-center items-center rounded-full cursor-pointer'>
                    <img src={icon1_2 || defaultImage} className="w-[40%]" alt="no image found"></img>
                    </div>
                </div>
            </div>
        </>
