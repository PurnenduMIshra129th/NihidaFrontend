        ...
        <>
            <Formik
                ...
                onSubmit={(values) => {
                    ...
                    uploadMedia("/carousel/createCarousel", formData)
                        // eslint-disable-next-line no-console
                        .then((response: unknown) => console.log("Carousel Uploaded Successfully:", response))
                        // eslint-disable-next-line no-console
                        .catch((error: unknown) => console.error("Error uploading carousel:", error));
                }}
            >{({ handleSubmit }) => (
