...
export const TelegramIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg
    ...
    {...props}
  >
    <defs xmlns="http://www.w3.org/2000/svg"><linearGradient id="logosTelegram0" x1="50%" x2="50%" y1="0%" y2="100%"><stop offset="0%" stopColor="#2AABEE" /><stop offset="100%" stopColor="#229ED9" /></linearGradient></defs><path xmlns="http://www.w3.org/2000/svg" fill="url(#logosTelegram0)" d="M128 0C94.06 0 61.48 13.494 37.5 37.49A128.038 128.038 0 0 0 0 128c0 33.934 13.5 66.514 37.5 90.51C61.48 242.506 94.06 256 128 256s66.52-13.494 90.5-37.49c24-23.996 37.5-56.576 37.5-90.51c0-33.934-13.5-66.514-37.5-90.51C194.52 13.494 161.94 0 128 0Z" /><path xmlns="http://www.w3.org/2000/svg" fill="#FFF" d="M57.94 126.648c37.32-16.256 62.2-26.974 74.64-32.152c35.56-14.786 42.94-17.354 47.76-17.441c1.06-.017 3.42.245 4.96 1.49c1.28 1.05 1.64 2.47 1.82 3.467c.16.996.38 3.266.2 5.038c-1.92 20.24-10.26 69.356-14.5 92.026c-1.78 9.592-5.32 12.808-8.74 13.122c-7.44.684-13.08-4.912-20.28-9.63c-11.26-7.386-17.62-11.982-28.56-19.188c-12.64-8.328-4.44-12.906 2.76-20.386c1.88-1.958 34.64-31.748 35.26-34.45c.08-.338.16-1.598-.6-2.262c-.74-.666-1.84-.438-2.64-.258c-1.14.256-19.12 12.152-54 35.686c-5.1 3.508-9.72 5.218-13.88 5.128c-4.56-.098-13.36-2.584-19.9-4.708c-8-2.606-14.38-3.984-13.82-8.41c.28-2.304 3.46-4.662 9.52-7.072Z" />
  </svg>
);
// eslint-disable-next-line @typescript-eslint/naming-convention
export const YoutubeIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg
    ...
    {...props}
  >
    <path xmlns="http://www.w3.org/2000/svg" fill="red" d="M250.346 28.075A32.18 32.18 0 0 0 227.69 5.418C207.824 0 127.87 0 127.87 0S47.912.164 28.046 5.582A32.18 32.18 0 0 0 5.39 28.24c-6.009 35.298-8.34 89.084.165 122.97a32.18 32.18 0 0 0 22.656 22.657c19.866 5.418 99.822 5.418 99.822 5.418s79.955 0 99.82-5.418a32.18 32.18 0 0 0 22.657-22.657c6.338-35.348 8.291-89.1-.164-123.134Z" /><path xmlns="http://www.w3.org/2000/svg" fill="#FFF" d="m102.421 128.06l66.328-38.418l-66.328-38.418z" />
  </svg>
);
...
// eslint-disable-next-line @typescript-eslint/naming-convention
export const WhatsappIconIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 256 258"
    width={size}
    ...
    {...props}
  >
    <defs xmlns="http://www.w3.org/2000/svg"><linearGradient id="logosWhatsappIcon0" x1="50%" x2="50%" y1="100%" y2="0%"><stop offset="0%" stopColor="#1FAF38" /><stop offset="100%" stopColor="#60D669" /></linearGradient><linearGradient id="logosWhatsappIcon1" x1="50%" x2="50%" y1="100%" y2="0%"><stop offset="0%" stopColor="#F9F9F9" /><stop offset="100%" stopColor="#FFF" /></linearGradient></defs><path xmlns="http://www.w3.org/2000/svg" fill="url(#logosWhatsappIcon0)" d="M5.463 127.456c-.006 21.677 5.658 42.843 16.428 61.499L4.433 252.697l65.232-17.104a122.994 122.994 0 0 0 58.8 14.97h.054c67.815 0 123.018-55.183 123.047-123.01c.013-32.867-12.775-63.773-36.009-87.025c-23.23-23.25-54.125-36.061-87.043-36.076c-67.823 0-123.022 55.18-123.05 123.004" /><path xmlns="http://www.w3.org/2000/svg" fill="url(#logosWhatsappIcon1)" d="M1.07 127.416c-.007 22.457 5.86 44.38 17.014 63.704L0 257.147l67.571-17.717c18.618 10.151 39.58 15.503 60.91 15.511h.055c70.248 0 127.434-57.168 127.464-127.423c.012-34.048-13.236-66.065-37.3-90.15C194.633 13.286 162.633.014 128.536 0C58.276 0 1.099 57.16 1.071 127.416Zm40.24 60.376l-2.523-4.005c-10.606-16.864-16.204-36.352-16.196-56.363C22.614 69.029 70.138 21.52 128.576 21.52c28.3.012 54.896 11.044 74.9 31.06c20.003 20.018 31.01 46.628 31.003 74.93c-.026 58.395-47.551 105.91-105.943 105.91h-.042c-19.013-.01-37.66-5.116-53.922-14.765l-3.87-2.295l-40.098 10.513l10.706-39.082Z" /><path xmlns="http://www.w3.org/2000/svg" fill="#FFF" d="M96.678 74.148c-2.386-5.303-4.897-5.41-7.166-5.503c-1.858-.08-3.982-.074-6.104-.074c-2.124 0-5.575.799-8.492 3.984c-2.92 3.188-11.148 10.892-11.148 26.561c0 15.67 11.413 30.813 13.004 32.94c1.593 2.123 22.033 35.307 54.405 48.073c26.904 10.609 32.379 8.499 38.218 7.967c5.84-.53 18.844-7.702 21.497-15.139c2.655-7.436 2.655-13.81 1.859-15.142c-.796-1.327-2.92-2.124-6.105-3.716c-3.186-1.593-18.844-9.298-21.763-10.361c-2.92-1.062-5.043-1.592-7.167 1.597c-2.124 3.184-8.223 10.356-10.082 12.48c-1.857 2.129-3.716 2.394-6.9.801c-3.187-1.598-13.444-4.957-25.613-15.806c-9.468-8.442-15.86-18.867-17.718-22.056c-1.858-3.184-.199-4.91 1.398-6.497c1.431-1.427 3.186-3.719 4.78-5.578c1.588-1.86 2.118-3.187 3.18-5.311c1.063-2.126.531-3.986-.264-5.579c-.798-1.593-6.987-17.343-9.819-23.64" />
  </svg>
);
// eslint-disable-next-line @typescript-eslint/naming-convention
...
export const ArrowRightDoubleFillIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg
    ...
    {...props}
  >
    <path xmlns="http://www.w3.org/2000/svg" fill="currentColor" d="m19.164 12l-6.207-6.207l-1.414 1.414L16.336 12l-4.793 4.793l1.414 1.414L19.164 12Zm-5.65 0L7.307 5.793L5.893 7.207L10.686 12l-4.793 4.793l1.414 1.414L13.514 12Z" />
  </svg>
);
// eslint-disable-next-line @typescript-eslint/naming-convention
export const StarIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg
    ...
    {...props}
  >
    <path xmlns="http://www.w3.org/2000/svg" fill="currentColor" d="M62 25.154H39.082L32 3l-7.082 22.154H2l18.541 13.693L13.459 61L32 47.309L50.541 61l-7.082-22.152L62 25.154z" />
  </svg>
);
// eslint-disable-next-line @typescript-eslint/naming-convention
export const QuoteLeftIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const MessageIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg
    ...
    {...props}
  >
    <path xmlns="http://www.w3.org/2000/svg" fill="currentColor" d="M0 8v8a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8l-10 4z" /><path xmlns="http://www.w3.org/2000/svg" fill="currentColor" d="M2 2a2 2 0 0 0-2 2v2l10 4l10-4V4a2 2 0 0 0-2-2z" />
  </svg>
);
// eslint-disable-next-line @typescript-eslint/naming-convention
...
export const ContactsFilledIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg
    ...
    {...props}
  >
    <path xmlns="http://www.w3.org/2000/svg" fill="currentColor" d="M15.436 14.778c-.595-.25-1.336-.563-1.336-.803v-1.57A3.549 3.549 0 0 0 15.5 9.6V7.5C15.5 5.57 13.93 4 12 4S8.5 5.57 8.5 7.5v2.1a3.55 3.55 0 0 0 1.4 2.806v1.569c0 .226-.734.54-1.323.792C7.152 15.376 5 16.296 5 18.7v.35h14v-.35c0-2.42-2.144-3.324-3.564-3.922" opacity=".25" /><path xmlns="http://www.w3.org/2000/svg" fill="currentColor" d="M8.5 9.5v-2a3.5 3.5 0 1 1 7 0v2c0 1.19-.593 2.24-1.5 2.873v.95a1 1 0 0 0 .629.928l1.586.635A4.431 4.431 0 0 1 19 19H5a4.431 4.431 0 0 1 2.785-4.114l1.586-.635a1 1 0 0 0 .629-.928v-.95A3.496 3.496 0 0 1 8.5 9.5" />
  </svg>
);
// eslint-disable-next-line @typescript-eslint/naming-convention
export const EmailIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg
    ...
    {...props}
  >
    <path xmlns="http://www.w3.org/2000/svg" fill="currentColor" d="M40.5 31.5v-18S22.3 26.2 20.53 26.859C18.79 26.23.5 13.5.5 13.5v18c0 2.5.53 3 3 3h34c2.529 0 3-.439 3-3zm-.029-21.529c0-1.821-.531-2.471-2.971-2.471h-34c-2.51 0-3 .78-3 2.6l.03.28s18.069 12.44 20 13.12c2.04-.79 19.97-13.4 19.97-13.4l-.029-.129z" />
  </svg>
);
// eslint-disable-next-line @typescript-eslint/naming-convention
...
export const AddressIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg
    ...
    {...props}
  >
    <path xmlns="http://www.w3.org/2000/svg" fill="currentColor" d="M960.5 768h-896q-26 0-45-19t-19-45V64q0-27 19-45.5T64.5 0h896q26 0 45 18.5t19 45.5v640q0 26-19 45t-45 19zm-800-128h256q13 0 22.5-9.5t9.5-22.5t-9.5-22.5t-22.5-9.5h-256q-13 0-22.5 9.5t-9.5 22.5t9.5 22.5t22.5 9.5zm320-320h-320q-13 0-22.5 9.5t-9.5 22.5t9.5 22.5t22.5 9.5h320q13 0 22.5-9.5t9.5-22.5t-9.5-22.5t-22.5-9.5zm0 128h-320q-13 0-22.5 9.5t-9.5 22.5t9.5 22.5t22.5 9.5h320q13 0 22.5-9.5t9.5-22.5t-9.5-22.5t-22.5-9.5zm416-288q0-13-9.5-22.5t-22.5-9.5h-192q-13 0-22.5 9.5t-9.5 22.5v192q0 13 9.5 22.5t22.5 9.5h192q13 0 22.5-9.5t9.5-22.5V160z" />
  </svg>
);
// eslint-disable-next-line @typescript-eslint/naming-convention
...
export const TelegramIconChangedBG = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg
    ...
    {...props}
  >
    <path xmlns="http://www.w3.org/2000/svg" fill="currentColor" d="M470.435 45.423L16.827 221.249c-18.254 8.188-24.428 24.585-4.412 33.484l116.37 37.173l281.368-174.79c15.363-10.973 31.091-8.047 17.557 4.024L186.053 341.075l-7.591 93.076c7.031 14.371 19.905 14.438 28.117 7.295l66.858-63.589l114.505 86.187c26.595 15.826 41.066 5.613 46.788-23.394l75.105-357.47c7.798-35.705-5.5-51.437-39.4-37.757z" />
  </svg>
);
// eslint-disable-next-line @typescript-eslint/naming-convention
export const QuoteAltIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const PlusIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg 
    ...
    {...props}
  >
    <path xmlns="http://www.w3.org/2000/svg" fill="currentColor" fillRule="evenodd" d="M8 2.75a.5.5 0 0 0-1 0V7H2.75a.5.5 0 0 0 0 1H7v4.25a.5.5 0 0 0 1 0V8h4.25a.5.5 0 0 0 0-1H8V2.75Z" clipRule="evenodd"/>
  </svg>
);
// eslint-disable-next-line @typescript-eslint/naming-convention
export const BlogIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg 
    ...
    {...props}
  >
    <path xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" strokeWidth="2" d="M5 16a3 3 0 1 0 0 6a3 3 0 0 0 0-6ZM5 1c9.925 0 18 8.075 18 18m-5 0c0-7.168-5.832-13-13-13m8 13c0-4.411-3.589-8-8-8m-3 0v8"/>
  </svg>
);
// eslint-disable-next-line @typescript-eslint/naming-convention
export const NewsIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg 
    ...
    {...props}
  >
    <path xmlns="http://www.w3.org/2000/svg" fill="#FF5722" d="M32 15v28H10c-2.2 0-4-1.8-4-4V15h26z"/><path xmlns="http://www.w3.org/2000/svg" fill="#FFCCBC" d="M14 5v34c0 2.2-1.8 4-4 4h29c2.2 0 4-1.8 4-4V5H14z"/><path xmlns="http://www.w3.org/2000/svg" fill="#FF5722" d="M20 10h18v4H20zm0 7h8v2h-8zm10 0h8v2h-8zm-10 4h8v2h-8zm10 0h8v2h-8zm-10 4h8v2h-8zm10 0h8v2h-8zm-10 4h8v2h-8zm10 0h8v2h-8zm-10 4h8v2h-8zm10 0h8v2h-8zm-10 4h8v2h-8zm10 0h8v2h-8z"/>
  </svg>
);
// eslint-disable-next-line @typescript-eslint/naming-convention
export const ISocialServicesIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 64 64" 
    width={size} 
